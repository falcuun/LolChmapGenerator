...
public class RolesComboBox {
    ...
    public void opnWebguideAssassins() throws Exception {
        switch (comboBox.getSelectedIndex()) {
            case 0:
    ...
    public void openWebGuideFighters() throws Exception {
        switch (comboBox.getSelectedIndex()) {
            case 0:
    ...
    public void openWebGuideTanks() throws Exception {
        switch (comboBox.getSelectedIndex()) {
            case 0:
    ...
    public void openWebGuideMages() throws Exception {
        switch (comboBox.getSelectedIndex()) {
            case 0:
    ...
    public void openWebGuideSupports() throws Exception {
        switch (comboBox.getSelectedIndex()) {
            case 0:
    ...
    public void openWebGuideMarksman() throws Exception {
        switch (comboBox.getSelectedIndex()) {
            case 0:
                dt.browse(new URI("http://www.mobafire.com/league-of-legends/ahse-guide"));
                break;
            case 1:
    ...
    public RolesComboBox(JComboBox jcb, JLabel la) {
        this.comboBox = jcb;
        this.label = la;
